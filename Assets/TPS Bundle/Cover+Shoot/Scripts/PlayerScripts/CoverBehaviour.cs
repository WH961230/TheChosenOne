...
public class CoverBehaviour : GenericBehaviour
{
	...
	public void OnStart ()
	{
		foreach (var VARIABLE in GameObject.Find("Signs").transform) {
			var go = VARIABLE as Transform;
			if (go.gameObject.name == "CoverSign") {
				coverSign = go.gameObject;
			} else if (go.gameObject.name == "TurnCoverSign") {
				turnCoverSign = go.gameObject;
			} else if (go.gameObject.name == "ChangeCoverSign") {
				changeCoverSign = go.gameObject;
			} else if (go.gameObject.name == "JumpCoverSign") {
				jumpCoverSign = go.gameObject;
			}
		}
